#ifndef	_BUGSHAN_REFLECTION_H_
#define	_BUGSHAN_REFLECTION_H_
...
namespace BugShan
{
	namespace Reflection
	{
		...
		public:
			...
			inline Method(const char* const methodName, T methodPtr);
		...
		/*===================================class Method===============================*/
		template<typename T, typename/* = typename std::enable_if<std::is_member_pointer<T>::value, void>::type*/>
		inline Method::Method(const char* const methodName, T methodPtr)
			: mpName(methodName)
		...
		inline const char* const Method::GetNamePtr(void) const
		{ return this->mpName; }
